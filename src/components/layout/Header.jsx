...
import { FaBell, FaThLarge, FaUserCircle } from "react-icons/fa";
...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-white text-gray-800 border-b border-gray-200 z-40 shadow-md">
      <div className="flex items-center justify-between h-16">
        ...
        <div className="flex items-center">
          ...
          <div className="hidden md:block ml-4">
            <span className="text-lg font-semibold text-gray-900">BG Verification Dashboard</span>
          </div>
        </div>
