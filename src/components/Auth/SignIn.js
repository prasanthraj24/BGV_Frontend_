  ...
  return (
    <div className="fixed inset-0 bg-gray-100 flex flex-col lg:flex-row">
      ...
      <motion.div
        ...
        animate={{ opacity: 1 }}
        transition={{ duration: 0.8 }}
        className="lg:w-1/2 flex items-center justify-center p-6 bg-gray-100 flex-grow"
      >
        <motion.div
          {...fadeInUp}
          transition={{ delay: 0.4, ...fadeInUp.transition }}
        ...
        >
          ...
          <form onSubmit={handleSignIn} className="space-y-4">
            <motion.div {...fadeInUp} transition={{ delay: 0.7, ...fadeInUp.transition }}>
            ...
            <motion.div {...fadeInUp} transition={{ delay: 0.8, ...fadeInUp.transition }}>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Password
              </label>
              <div className="relative">
            ...
            <motion.div {...fadeInUp} transition={{ delay: 0.9, ...fadeInUp.transition }}
